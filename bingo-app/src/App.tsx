...
const BingoTextItem = (props: BingoTextProps) => {
  return (
    <Grid item xs={2}>
      <Card style={{ backgroundColor: "darkred", color: "white" }}>
        <h1 style={{ textAlign: "center" }}>{props.content}</h1>
      </Card>
    </Grid>
  );
};
...
function App() {
  ...
  return (
    <div>
      ...
      >
        <Grid item xs={1} />
        <BingoTextItem content="B" />
        <BingoTextItem content="I" />
        <BingoTextItem content="N" />
        <BingoTextItem content="G" />
        <BingoTextItem content="O" />
        <Grid item xs={1} />
